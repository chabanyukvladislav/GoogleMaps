...
namespace MapsApiStandardLibrary.Api.Parameters.Directions
{
        ...
        public static implicit operator DirectionsParameters(string param)
        {
            ...
            foreach (var parameter in parameters)
            {
                ...
                switch (nameValue.Key)
                {
                    ...
                    case "mode":
                        {
                            result.Mode = (Modes)Enum.Parse(typeof(Modes), nameValue.Value.ToUpperFirstSymbol());
                            break;
                        }
                    case "waypoints":
                        {
                    ...
                    case "avoid":
                        {
                            result.Avoid = (Avoids)Enum.Parse(typeof(Avoids), nameValue.Value.ToUpperFirstSymbol());
                            break;
                        }
                    case "units":
                        {
                            result.Units = (Units)Enum.Parse(typeof(Units), nameValue.Value.ToUpperFirstSymbol());
                            break;
                        }
                    case "arrival_time":
                        {
                    ...
                    case "traffic_model":
                        {
                            result.TrafficModel = (TrafficModels)Enum.Parse(typeof(TrafficModels), nameValue.Value.ToUpperFirstSymbol());
                            break;
                        }
                    case "transit_mode":
                        {
                            result.TransitMode = (TransitModes)Enum.Parse(typeof(TransitModes), nameValue.Value.ToUpperFirstSymbol());
                            break;
                        }
